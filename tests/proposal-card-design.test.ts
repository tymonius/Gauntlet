...
describe("Diplomat Proposal / Treaty Article prototypes", () => {
  ...
  it("turns the artwork field into an explicit ratification treatment using Declaration Blackletter", () => {
    ...
    expect(proposalStyles).toContain('@font-face');
    expect(proposalStyles).toContain('font-family: "Gauntlet Declaration Blackletter"');
    expect(proposalStyles).toContain('local("P22 Declaration Blackletter")');
    expect(proposalStyles).toContain('"P22 Declaration Blackletter"');
