...
describe("Inquisition canonical text color", () => {
  it("keeps the canonical ochre in public faction text instead of substituting a darker accessibility variant", () => {
    ...
    expect(factionStyles).toContain("--faction: #a67a27");
