...
describe('shared card inspector orientation', () => {
  it('uses renderer-reported orientation for unified face inspection', () => {
    expect(sharedInspection).toContain('width: PRODUCTION_SURFACES.portrait.widthCssPx');
    expect(sharedInspection).toContain('height: PRODUCTION_SURFACES.portrait.heightCssPx');
    expect(sharedInspection).toContain('width: PRODUCTION_SURFACES.landscape.widthCssPx');
    expect(sharedInspection).toContain('height: PRODUCTION_SURFACES.landscape.heightCssPx');
