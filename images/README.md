...
This directory contains Gauntlet's visual source material. It is not a general-purpose dump for generated or duplicate copies.
...
Do not retain a second binary under `artwork/reference/` once that exact image is already the approved production artwork under `artwork/cards/`. Preserve useful provenance or old descriptive names as documentation rather than another multi-megabyte copy.

The following historical reference names resolve conceptually to their approved card-art locations:
