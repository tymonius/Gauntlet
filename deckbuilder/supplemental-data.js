window.GAUNTLET_V06_SUPPLEMENTALS = {
  ...
  diplomats: {
    ...
    proposals: [
      ...
      { number: 4, name: "Open Channels", stake: 1, requirement: "You must have a card in hand.", accepted: "Both players reveal their hands, then withdraw. The opponent draws one card.", refused: "Look at the opponent's hand. During battle draw, draw one additional card before choosing your Tactic." },
      { number: 5, name: "Mutual Disarmament", stake: 1, requirement: "Both players must have a card in hand.", accepted: "Each player discards one card from hand. The opponent draws one card, then both players withdraw.", refused: "You may discard one card from hand. If you do, during battle draw, draw one additional card before choosing your Tactic." },
    ...
    components: [
      ...
      },
      {
        ...
        sections: [
          ...
          { label: "Condemnation", text: "In battles involving you, opposing played Tactics go to their owner's Graveyard after the battle instead of discard. Hand commitments already go to the Graveyard. Unplayed Tactics are discarded normally." },
