...
<head>
  ...
  <style>
    * { box-sizing: border-box; }
    ...
    .card-header { position: relative; display: flex; align-items: center; min-height: 0.38in; padding: 0.05in 0.46in 0.05in 0.1in; background: #eee; }
    .card-name { font-weight: 800; font-size: 12.6pt; line-height: 1.02; }
    .cost-circle { position: absolute; top: 0.045in; right: 0.17in; width: 0.31in; height: 0.31in; border: 1.5px solid #111; border-radius: 50%; display: flex; align-items: center; justify-content: center; background: #fff; font-weight: 800; font-size: 12pt; line-height: 1; }
    ...
    .card-footer { display: grid; grid-template-columns: 1fr 1fr 1fr; align-items: center; gap: 0.04in; padding: 0.035in 0.06in; background: #eee; font-size: 5.3pt; line-height: 1; }
    ...
    .territory-header { display: flex; align-items: end; gap: 0.08in; padding: 0.05in 0.1in; background: #eee; }
    ...
    .territory-footer { display: flex; justify-content: space-between; align-items: center; padding: 0.035in 0.06in; background: #eee; font-size: 5.3pt; }
