...
export const coreCardPlayRules: Record<CardID, CardPlayRule> = {
  ...
  'neutral-arcane-knowledge': actionOnly('neutral-arcane-knowledge', 'discard', true),
  ...
  'neutral-assimilation': battleAndAction('neutral-assimilation', 'asset_bank'),
  ...
  'neutral-armistice': battleAndAction('neutral-armistice', 'asset_bank'),
