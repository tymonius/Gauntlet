...
**v0.6 rule direction:** Keep Protracted Siege as shared capture-delay counterplay, but make each copy an expendable Territory Overlay rather than a persistent global Asset or a Condition.

**Working v0.6 Action direction:** Bank Protracted Siege as an Asset. When your opponent occupies a Territory you control, you may move Protracted Siege from your Asset bank onto that Territory as an Overlay. When they would capture that Territory at the start of their turn, discard Protracted Siege instead. They do not capture it. If they cease occupying the Territory, discard Protracted Siege.
