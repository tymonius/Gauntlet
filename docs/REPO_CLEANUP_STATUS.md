...
Next: validate [#1482](https://github.com/tymonius/Gauntlet/pull/1482) in CI, then continue classifying active version-named validation and reconstruction commands. Prefer explicit authority/config inputs for maintained tools, archive closed withdrawn-release pipelines, and leave genuine historical reproduction contracts pinned.
