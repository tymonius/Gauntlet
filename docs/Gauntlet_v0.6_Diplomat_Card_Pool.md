# Gauntlet v0.6 Diplomat Card Pool

**Status:** Authoritative working exact-text source for the selected twelve-card v0.6 Diplomat package.  
**Purpose:** Consolidate the current Diplomat card names, costs, complexity, card forms, exact text, package structure, and playtest watchlist in one active document.
...
- **Average cost:** 2.92
- **Curve:** 1 / 3 / 5 / 2 / 1 at costs 1–5
- **Archived concept:** Recognition of Claims
...
The package supports overlapping approaches rather than named subpackages:
...
**Recognition of Claims** was cut from the twelve-card package. Its territorial-concession concept was memorable, but it overlapped with other acceptance incentives, created Proposal-position sequencing questions, and relied on a comparatively generic conditional Battle bonus.
