...
This document governs the adopted v0.6.3 changes to setup, starting position, opening Hand selection, Territory arrangement, the final Territory, Last Stand access, and the normal shared victory condition.
...
Prepare faction components, then shuffle the remaining cards in your Playable Deck. Draw four, choose one to discard, and keep the other three as your opening Hand.
...
1. **Prepare faction components.** Place Leaders, trackers, references, supplemental components, and any cards removed from or added to the Playable Deck according to their rules.
2. **Prepare Draw Piles and opening Hands.** Shuffle your remaining cards to form your Draw Pile. Draw four cards, choose one card from those four, and place it face up in your Discard Pile. The other three cards form your opening Hand.
...
- Prepare faction components that affect the Playable Deck.
