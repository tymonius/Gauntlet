...
## Multiplayer / Gauntlet: Arena

Multiplayer is no longer a parked concept. Active development has begun on **Gauntlet: Arena**, a four-player free-for-all mode provisionally targeted for v0.7.

The current design, open questions, prototype boundaries, and revision history are maintained under [`docs/arena/`](arena/README.md). Progress is tracked in [issue #523](https://github.com/tymonius/Gauntlet/issues/523).

The earlier dual-lane, cross-board, alliance, and free-for-all notes that previously appeared here are preserved in repository history. They do not govern the active Arena prototype.

### Current Decision

Remove multiplayer from the parking lot and develop it through the Arena documentation track. Do not add Arena rules to the canonical v0.6.2 sources or generated artifacts until a later Arena release is approved.
