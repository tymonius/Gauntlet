...
The targeted expressive-provenance audit is now complete enough to support working application language. See `V0_6_0_EXPRESSIVE_PROVENANCE_AUDIT.md`.

Candidate `Author Created` language:

> Text; revisions and editing; selection, coordination, and arrangement.

The three-paragraph Welcome is excluded below because its final sentence-level prose was supplied by ChatGPT after human substantive direction and editorial correction. That exclusion does not alter the sole-human-author posture for the claimed authorship in the Rulebook as a whole.

## Material to exclude / limitation of claim

The targeted audit identifies one known appreciable AI-drafted literary block and removes visual provenance from this Literary Work filing by excluding all pictorial material.

Candidate `Material Excluded / Other` language:
...
Working meaning:
- **introductory text generated by artificial intelligence** = the three-paragraph `Welcome to Gauntlet` prose in the July 20 publication snapshot;
- **pictorial material** = all images/illustrations in the Rulebook deposit, regardless of their eventual human/AI classification;
- **preexisting Gauntlet material** = all appreciable expression first published before v0.6.0;
- **game methods and systems** = methods of play, procedures, systems, facts, short functional matter, titles, and other unclaimable material to the extent applicable.

Material is not excluded merely because AI was used for proofreading, suggestions, organization, consistency checking, or other assistive functions.
...
The human author is identified in the Author section; the limitation-of-claim language above excludes the known AI-drafted Welcome and other unclaimed material.
...
- [x] Complete the section-level Rulebook authorship pass. See `V0_6_0_RULEBOOK_AUTHORSHIP_AUDIT.md`.
