...
**Given:** Faction setup and Playable-Deck modifications are complete.  
**When:** A player prepares the opening Hand.  
**Then:** The player shuffles the remaining cards to form the Draw Pile and draws four cards.
...
The initial v0.6.3 source-layer implementation must not modify files under `releases/v0.6.2/`.
