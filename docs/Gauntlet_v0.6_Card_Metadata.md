...
|---:|---|---|---|---|---|
| 1 | Arcane Knowledge | Arcane | TBD | Advanced | Wording and eligible-effect boundaries |
| 2 | Armistice | Neutral | No | Advanced | Stall potential and Diplomat interactions |
| 3 | Assassins | Intelligence | TBD | Advanced | Mission requirement and disruption density |
| 4 | Assimilation | Neutral | No | Advanced | Immediate-capture density |
| 5 | Attrition | Neutral | No | Advanced | Long-game card denial and Inquisition overlap |
| 6 | Blockade | Diplomat | No | Advanced | Sanctions redesign pending |
...
| 9 | Capital Punishment | Neutral | No | Advanced | Hard-cancellation severity |
...
| 13 | Court Martial | Neutral | Yes | Basic | Forced-retreat wording |
| 14 | Decoys | Neutral | Yes | Basic | Scope of cancellation protection |
| 15 | Disruption | Neutral | Yes | Basic | Overlap with future Sanctions cards |
...
| 29 | Palisade Wall | Neutral | Yes | Basic | None |
