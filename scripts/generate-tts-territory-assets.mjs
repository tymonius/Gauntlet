...
async function main() {
  ...
  if (checkOnly) {
    console.log(`TTS Territory source check passed: ${catalog.territories.length} Territories, including ${catalog.territories.filter((territory) => territory.arena).length} Arenas.`);
    return;
  }
