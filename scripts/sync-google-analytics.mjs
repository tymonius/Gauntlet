...
const ANALYTICS_EXCLUDED_FILES = new Set([
  ...
  // Compatibility redirects and render-only modular-rules surfaces; analytics belongs on /rulebook/.
  "apps/rules/booklet/index.html",
  "apps/rules/comprehensive/index.html",
  "apps/rules/factions/diplomats/index.html",
  "apps/rules/factions/financiers/index.html",
  "apps/rules/factions/index.html",
  "apps/rules/factions/inquisition/index.html",
  "apps/rules/factions/intelligence/index.html",
  "apps/rules/factions/military/index.html",
  "apps/rules/factions/mystics/index.html",
  "apps/rules/index.html",
  "apps/rules/player-guide/index.html",
