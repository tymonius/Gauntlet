...
function capitalLedgerXml() {
  ...
  return `<Panel id="ledger-window" active="false" width="820" height="930" position="0 0 -50" rotation="0 180 0" color="#E8D9B8F5" outline="#31291F" outlineSize="3 3" padding="22 22 22 22">
