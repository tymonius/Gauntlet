...
Public `start/`, the public Deckbuilder, `src/content/current.ts`, lifecycle state, print/export surfaces, and publication pointers remain unchanged. The clean Deckbuilder and print/export handoff are intentionally absent. v0.6.1 remains current/public and publication remains locked.
