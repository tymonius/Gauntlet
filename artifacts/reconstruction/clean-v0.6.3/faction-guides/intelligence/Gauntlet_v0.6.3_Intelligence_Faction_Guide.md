...
# 7. Canonical Intelligence card pool
...
Deep Cover prevents Mission failure; it does not preserve a Special Operation unless the effect expressly refers to it.
...
- Gambit Surveillance: once per battle, 1 Intel.
...
Gauntlet v0.6.3 reconstruction candidate © 2026 Tymon Scott. All rights reserved. Intelligence Faction Guide.
