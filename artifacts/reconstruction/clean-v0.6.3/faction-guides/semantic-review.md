...
The build explicitly flags the finalized/bespoke faction cards whose wording or interaction behavior received special v0.6.3 attention: Shock and Awe, Reserve Force, Fog of War, Necromancy, Sleeper Network, Give Chase, Speculation, Hold the Line, Intercepted Orders, Nature's Altar, Field Command, Counterworks, Martyrdom, Rearguard. Their exact effect text is pinned to the finalized evidence payload rather than reinterpreted during reconstruction.
