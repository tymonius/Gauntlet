...
export type PendingFinancierChoice =
  ...
  | { kind: 'subsidize'; playerId: PlayerID; maximumBonus: number; options: number[] }
  | { kind: 'deed_purchase'; playerId: PlayerID; spaceId: SpaceID; cost: number; currentOwner?: PlayerID; collateralOptions: CardID[]; maximumCollateralContribution: number };
