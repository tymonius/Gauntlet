...
import type { InquisitionAccusationQueueEntry, InquisitionDivineMercyBattleQueueEntry, InquisitionPenanceBattleQueueEntry, PendingInquisitionChoice } from './inquisition';
