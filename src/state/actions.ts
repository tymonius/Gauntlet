...
export interface ResolveInquisitionChoiceAction { type: 'resolve_inquisition_choice'; playerId: PlayerID; choice?: string; cardId: CardID; cardIds?: CardID[]; targetKey?: string; }
