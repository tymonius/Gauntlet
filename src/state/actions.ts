...
export interface ResolveNeutralChoiceAction { type: 'resolve_neutral_choice'; playerId: PlayerID; choice: 'pass' | 'use' | 'select_card' | 'select_cards'; cardId?: CardID; cardIds?: CardID[]; }
