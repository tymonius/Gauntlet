...
export function applyNoMartyrsOutcome(
  ...
  publicLog(
    ...
    `${game.players[winner].name} suppressed ${game.players[loser].name}’s loss and retreat effects and forced ${sourceCount} additional retreat position${sourceCount === 1 ? '' : 's'}.`,
