...
describe("Gate 3 blind tranche G certification freeze", () => {
  ...
  test("current Gate 3 workflow is pinned to G/r17 and remains OIDC-authorized", () => {
    ...
    expect(workflow).toContain("name: Rules Arbiter Gate 3 blind tranche G");
    expect(workflow).toContain("GATE3_EXPECTED_BEHAVIOR_REVISION: v071-qa-20260917-17");
    expect(workflow).toContain("rules-arbiter-gate3-blind-g.v071.json");
    expect(workflow).toContain("rules-arbiter-gate3-blind-g-player-language.v071.json");
    expect(workflow).toContain("rules-arbiter-gate3-blind-g-clarifications.v071.json");
    expect(workflow).toContain("rules-arbiter-gate3-blind-g-v0.7.1");
