...
describe("v0.7.1 Gate 2 r6 regressions", () => {
  test("pins the strengthened multi-phase Feature timing rule", () => {
    expect(BEHAVIOR_REVISION).toBe("v071-qa-20260915-14");
    ...
    expect(workerSource).toContain("If only one granted phase is legal for that Feature, the Feature must be used in that phase");
  });
