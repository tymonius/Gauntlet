...
const CLEAR_NON_GAMEPLAY_PATTERNS = [
  ...
  /\b(best|strongest|strong|optimal|most powerful|overpowered)\b[\s\S]*\b(strategy|deck|build|faction|leader)\b/i,
  /\b(?:leader|faction|deck|build)\b[\s\S]{0,60}\b(?:most\s+)?overpowered\b/i,
