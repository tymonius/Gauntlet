...
const MILITARY_COMMAND_AUTHORITY_IDS = [
  ...
  // The governing v0.7.2 candidate text is the reviewed Complete Rules document.
...
export default {
  async fetch(request, env = {}) {
    ...
    try {
      ...
      console.error(`v0.7.2 candidate Rules Arbiter failure during ${failureStage}`, error);
      const failure = {
