...
describe("Gate 3 blind tranche J certification freeze", () => {
  ...
  test("current Gate 3 workflow is pinned to J/r20 and remains OIDC-authorized", () => {
    ...
    expect(workflow).toContain("name: Rules Arbiter Gate 3 blind tranche J");
    expect(workflow).toContain("GATE3_EXPECTED_BEHAVIOR_REVISION: v071-qa-20260918-20");
    expect(workflow).toContain("rules-arbiter-gate3-blind-j.v071.json");
    expect(workflow).toContain("rules-arbiter-gate3-blind-j-player-language.v071.json");
    expect(workflow).toContain("rules-arbiter-gate3-blind-j-clarifications.v071.json");
    expect(workflow).toContain("rules-arbiter-gate3-blind-j-v0.7.1");
