...
const TRIAGE_STYLE = String.raw`
    ...
    .triage-summary{display:grid;grid-template-columns:repeat(5,minmax(100px,1fr));gap:8px;margin:10px 0}
    ...
    @media(max-width:1100px){.triage-summary{grid-template-columns:repeat(3,minmax(0,1fr))}}
