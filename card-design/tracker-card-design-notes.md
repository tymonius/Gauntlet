...
| Intel | 0–20 | Operations Reference Card | Intel is uncapped. In the two current competitive Intelligence starters, the six highest available normal-Mission rewards total 18 (Ranger) and 17 (Spymaster) before spending, so 20 covers a normal high-water mark with a small buffer. |
