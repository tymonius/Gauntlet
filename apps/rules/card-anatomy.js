...
function wrapAuthoredAnatomy() {
  ...
  // The maintained Markdown carries deterministic static figures for print/PDF.
  // The interactive Player's Guide replaces those fallbacks with live production renders.
