...
5. Each **Save position** updates `packages/game-data/current-game.json` (`artDirection`) on `artwork/compositor-authoring` and creates or reuses one pull request against `main`.
