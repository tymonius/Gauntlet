const cards = [
  { name: 'Clemency', cost: 1, meta: 'Diplomats • Basic', effects: [['Action', "Choose a card in the opponent's Graveyard. They choose one: move it to their Discard Pile and you gain 1 Influence; or leave it there and you draw one card."]] },
  { name: 'Trade Concessions', cost: 2, meta: 'Diplomats • Advanced', effects: [['Terms', 'When you offer Terms, before the opponent accepts or refuses, you may reveal this from hand and set it aside.'], ['Accepted', 'The opponent chooses one available option: draw two cards; or bank one eligible card from hand as an Asset without using an Action Opportunity. Then discard this and draw one card.'], ['Refused', 'Return this to your hand before the battle.'], ['Battle', 'The opponent draws one card. Add +2 to your battle total.']] },
  { name: 'Safe Conduct', cost: 2, meta: 'Diplomats • Advanced • Asset', effects: [['Action', 'Bank this as an Asset.'], ['Reaction', 'When you would lose a battle following refused Terms, you may discard this to withdraw instead. The opponent remains in or occupies the contested position, and the battle ends without a winner.']] },
  { name: 'Neutral Observers', cost: 2, meta: 'Diplomats • Advanced • Asset', effects: [['Action', 'Bank this as an Asset.'], ['Reaction', 'After Terms are refused, before either player commits a card from hand, you may discard this. The opponent first commits one card from hand face up for its Battle effect or declines to commit; then you commit normally.']] },
  { name: 'Good Faith', cost: 3, meta: 'Diplomats • Advanced • Asset', effects: [['Action', 'Bank this as an Asset.'], ['Terms', 'When you offer Terms, before the opponent accepts or refuses, you may discard this to draw one card, then reveal one card from hand and set it aside.'], ['Accepted', 'Put that card in your Graveyard.'], ['Refused', 'Return it to your hand before the battle.']] },
  { name: 'Demilitarized Zone', cost: 3, meta: 'Diplomats • Advanced • Territory Overlay', effects: [['Settlement', "After your Terms are accepted and the Proposal's Accepted effect resolves, you may place this as an Overlay on the contested Territory without using an Action Opportunity. Each player still there withdraws."], ['Overlay', 'Neither player may enter this Territory during the turn this is placed. To enter it while unoccupied, discard one card. It cannot be captured or change control while this remains. At the start of your turn, before the Capture step, if you occupy it, discard one card or withdraw. After the first battle fought here, discard this.']] },
  { name: 'Diplomatic Latitude', cost: 3, meta: 'Diplomats • Advanced', effects: [['Terms', 'When you offer Terms, you may reveal this from hand and offer two eligible Proposals with the same Stake instead of one. Stake that amount once.'], ['Accepted', 'The opponent chooses which Proposal is accepted.'], ['Refused', 'Choose one Proposal before resolving its Refused effect. Only it may be imposed.'], ['Cleanup', 'The other Proposal does not resolve or become ratified. After the Terms resolve, discard this.']] },
  { name: 'Nonbinding Resolution', cost: 3, meta: 'Diplomats • Advanced', effects: [['Terms', 'When you offer Terms, before the opponent accepts or refuses, you may reveal this from hand and set it aside.'], ['Accepted', 'If the Proposal is unratified, the opponent chooses one before ratification: ratify it normally; or leave it unratified and you gain 2 Influence. After the accepted Terms resolve, discard this, then draw one card.'], ['Refused', 'Discard this, then draw one card before the battle.']] },
  { name: 'Sanctions: Censure', cost: 3, meta: 'Diplomats • Advanced • Asset • Sanction', effects: [['Sanction', 'After an opponent refuses your Terms, you may bank this from hand without using an Action Opportunity.'], ['Asset', 'While banked, the first time each turn that opponent plays a card for its Action effect, they choose: discard one card, or you draw one card.'], ['Relief', 'After they accept your Terms, discard this.']] },
  { name: 'Gunboat Diplomacy', cost: 4, meta: 'Diplomats • Advanced', effects: [['Terms', 'When you offer Terms, before the opponent accepts or refuses, you may reveal this from hand.'], ['Accepted', 'Discard this.'], ['Refused', 'Reveal this face up in the resulting battle for its Battle effect.'], ['Battle', 'Add +2 to your battle total. After the battle, put this in your Discard Pile.']] },
  { name: 'Sanctions: Embargo', cost: 4, meta: 'Diplomats • Advanced • Asset • Sanction', effects: [['Sanction', 'After an opponent refuses your Terms, you may bank this from hand without using an Action Opportunity.'], ['Asset', "While banked, that opponent's Asset limit is reduced by 1, to a minimum of 0."], ['Relief', 'After they accept your Terms, discard this.']] },
  { name: 'Sanctions: Blockade', cost: 5, meta: 'Diplomats • Advanced • Territory Overlay • Sanction', effects: [['Sanction', "After the battle following an opponent's refusal of your Terms, you may place this as an Overlay on a Territory they control without using an Action Opportunity."], ['Overlay', 'The first time each turn that opponent enters or leaves this Territory, they choose: discard one card, or you gain 1 Influence.'], ['Relief', 'Discard this after they accept your Terms or lose control of this Territory.']] }
];

const leaders = [
  { name: 'Ambassador', image: '../images/ambassador.png', motto: 'Words first. War last.', abilityName: 'Cordiality', ability: 'Once per turn, after the opponent accepts your Terms, draw one card.' },
  { name: 'Senator', image: '../images/senator.png', motto: 'Procedure endures.', abilityName: 'Political Capital', ability: 'Once per turn, when you would lose staked Influence after losing a battle following refused Terms, you may put up to that many cards from hand in your Graveyard. Recover 1 staked Influence per card; lose the rest.' }
];
...
const proposals = [
  ...
  { number: 4, name: 'Open Channels', stake: 1, requirement: 'You must have a card in hand.', accepted: 'Both players reveal their hands, then withdraw. The opponent draws one card.', refused: "Look at the opponent's hand. When forming your Battle Hand, draw one additional card before choosing a card from it." },
