# Gauntlet v0.6.3 Faction and Component Guide

**Status:** Published  
**Version:** v0.6.3  
**Baseline:** v0.6.2 faction/component system, with adopted v0.6.3 replacements and synchronized card excerpts

This guide is extracted from the synchronized v0.6.3 Rulebook release candidate so the standalone faction/component reference cannot drift from the Rulebook. v0.6.3 is authoritative for published play until the v0.6.3 cutover.
