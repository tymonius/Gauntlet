# Gauntlet v0.6.1 Mystics Faction Guide

> **Definitive v0.6.1 Mystics faction source.** This guide governs Mystics-specific rules, Leaders, Rites, Ritual of Ascendance, Invocation, Transmutation, Convergence, bound cards, supplemental components, and exact Mystics card text. Shared rules remain in the v0.6.1 rulebook.
...
> **Action:** Put one other card from your Hand in your Graveyard. Move one additional position this turn. Resolve movement one position at a time.
>
...
Gauntlet v0.6.1 © 2026 Tymon Scott. All rights reserved. Mystics Faction Guide.
