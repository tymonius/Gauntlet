# Gauntlet v0.6.1 Intelligence Faction Guide

> **Definitive v0.6.1 Intelligence faction source.** This guide governs Intelligence-specific rules, Leaders, Intel, Missions, Operation Progress, Surveillance, Interference, Special Operations, supplemental components, and exact Intelligence card text. Shared rules remain in the v0.6.1 rulebook.
...
> **Action:** Place Fog of War as an Overlay on a revealed Territory. Remove it after the next battle fought there. During that battle, the controller of this Territory sets their Gambit and chooses their Tactics after the opponent's corresponding choice, regardless of who initiated the battle.
>
...
Gauntlet v0.6.1 © 2026 Tymon Scott. All rights reserved. Intelligence Faction Guide.
