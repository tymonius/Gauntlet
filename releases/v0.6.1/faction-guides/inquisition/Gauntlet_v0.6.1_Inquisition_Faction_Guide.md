# Gauntlet v0.6.1 Inquisition Faction Guide

> **Definitive v0.6.1 Inquisition faction source.** This guide governs Inquisition-specific rules, Leaders, Conviction, Condemnation, Blasphemy, Purge, Purification, supplemental components, and exact Inquisition card text. Shared rules remain in the v0.6.1 rulebook.
...
This permits one replacement, not an additional Tactic.
...
Gauntlet v0.6.1 © 2026 Tymon Scott. All rights reserved. Inquisition Faction Guide.
